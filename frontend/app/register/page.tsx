    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--bg-primary)" }}>
      <div style={{ width: "100%", maxWidth: 400, padding: "0 20px" }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <div style={{ color: "var(--text-muted)", fontSize: 12 }}>CREATE YOUR ACCOUNT</div>
          <div style={{ color: "var(--text-muted)", fontSize: 11, marginTop: 4 }}>First user registered becomes admin</div>
        </div>
        <div className="card">
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              <div style={{ color: "var(--text-muted)", fontSize: 11, marginBottom: 6, letterSpacing: "0.1em" }}>PASSWORD (MIN 8 CHARS)</div>
